...
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /*Step 1: Set the content type (tell the browser what is the type of the
        response data; e.g text/html, text/plain. In out case, we will responds
        with html data. */
        response.setContentType("text/html");
        
        //Step 2: Create the PrinWriter object. We name it as 'out'
